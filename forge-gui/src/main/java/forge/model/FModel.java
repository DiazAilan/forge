...
public final class FModel {
    ...
    // Modified: Include all cards as possible commanders (no filter)
    private static final Supplier<ItemPool<PaperCard>> commanderPool = Suppliers.memoize(() -> ItemPool.createFrom(getMagicDb().getCommonCards().getAllCardsNoAlt(), PaperCard.class));
